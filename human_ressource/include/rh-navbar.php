    ...
    <div class="flex-1">
      ...
      <div class="breadcrumbs text-sm ms-4">
        <?php
          if($page == 'dashboard'){
            echo'<ul>';
              echo'<li><a href="../human_ressource/dashboard.php">Ressources humaines</a></li>';
              echo'<li>Tableau de bord</li>';
            echo'</ul>';
          }elseif($page == 'congé'){
            echo'<ul>';
              echo'<li><a href="../human_ressource/dashboard.php">Ressources humaines</a></li>';
              echo'<li><a href="../human_ressource/leave.php">Congé</a></li>';
            echo'</ul>';
            ...
            echo'<ul>';
              echo'<li><a href="../dashboard.php">Ressources humaines</a></li>';
              echo'<li>Employés</li>';
              echo'<li><a href="../dashboard.php">Tableau de bord</a></li>';
            echo'</ul>';
          }
